...
摘自：脚本之家公众号&nbsp; &nbsp; &nbsp; &nbsp; 时间：2019年4月7号&nbsp; &nbsp; &nbsp; &nbsp; 原文：www.jianshu.com/p/d7665192aaaf
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpGwvott0K793kyIvVj51J26oT3pIv2OGdhWUbMfkI7yCVASezeRdy0A/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREphROFOHH1G7ysKEzLdNMfj9iasuys56US6icruBAkTiaNsxZlvOKrQ0icJg/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>MySQL查询过程</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpKtEOnBoiburZRvRCbgWt69ylbsh6CaEh4TiafNJIz7uz8e6aCEW9yialQ/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>平衡二叉树和二叉查找树</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpEUIyjibFTJU6AoU3LcBjqic5fTdKCqgicte78suYc3Vic49mnL2m1pojdQ/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>平衡二叉树的旋转</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpaY30ibrbXvSXToJhTTOuho7TibaHIHF8ZEc5Bwa5eXbAQJQt8orSXXIg/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>简化B+Tree</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpOSzvNO5EiavlMDkQLCDD9GvVoxS5RGf9Vzs1QPfjugKQSCAiazK1bhnA/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

<center>leaf page和index page都没有满</center>

接着插入下一个节点70，在`Index Page`中查询后得知应该插入到`50 - 70`之间的叶子节点，但叶子节点已满，这时候就需要进行也分裂的操作，当前的叶子节点起点为50，所以根据中间值来拆分叶子节点，如下图所示。

![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpZiaLuxP1jer2mJPCetIjibzyrRolq8vZyfgH7dhrbiaMWVb3LskzQVwfQ/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>Leaf Page拆分</center>

最后插入一个节点95，这时候`Index Page`和`Leaf Page`都满了，就需要做两次拆分，如下图所示。

![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpnclnQFmDuk1k1cIK0SLZQGqXsAc7ic6sCfznW4fj2cD03johiazaic2fg/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>Leaf Page与Index Page拆分</center>

拆分后最终形成了这样一颗树。

![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpts9KwznYaHaGF6vwQaQGictIbIylDYOxqOu7YzvlVhUcibR1dnA5ZHhg/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>最终树</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpr2TZ09pZeWwYybJ1yfUAt6B1peUs7WTUyeoblq57474ocgwXl9WbtA/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>左旋操作</center>
...
![img](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbueoJM5VHHDBh8Uf3cgajREpo44y3tWTheSEvjvbRZicKRapR88FMk7Q6NQfcxbMJ1TrjJmteuc2zEw/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
<center>索引如何组织数据存储，来自：高性能MySQL</center>
...
> [1] 姜承尧 著；MySQL技术内幕-InnoDB存储引擎；机械工业出版社，2013<br>
> [2] Baron Scbwartz 等著；宁海元 周振兴等译；高性能MySQL（第三版）; 电子工业出版社， 2013<br>
...
原文：http://www.cnblogs.com/huchong/p/10219318.html
